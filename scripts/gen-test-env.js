...
const latestTemplatePath = path.resolve(__dirname, '../lib/cli/cloudformation-template.json')
const { loadCredentials, downloadDeploymentTemplate } = require('../lib/cli/utils')
