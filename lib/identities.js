...
class Identities {
    constructor(opts) {
        ...
        this.byPub = (pub) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const identity = yield this.objects.get(link);
                return identity;
            }
            catch (err) {
        ...
        this.getAuthorInfo = (object) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { author, recipient } = {
                author: yield this.metaByPub(_sigPubKey),
            ...
            if (recipient)
                ret._recipient = recipient.permalink;
            return ret;
        });
        this.addAuthorInfo = (object) => __awaiter(this, void 0, void 0, function* () {
            const info = yield this.getAuthorInfo(object);
            return utils_1.setVirtual(object, info);
        });
        ...
        this.metaByPub = utils_1.cachifyFunction(this, 'metaByPub');
        this.byPermalink = utils_1.cachifyFunction(this, 'byPermalink');
    }
}
