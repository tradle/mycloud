    ...
    constructor({ provider, blockchain, network, tables, db, objects, env }) {
        ...
        this._sealPending = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield utils_1.seriesMap(pending, (sealInfo) => __awaiter(this, void 0, void 0, function* () {
                ...
                return yield this.recordWriteSuccess({
                    seal: sealInfo,
                    txId: result.txId
                });
            }));
        ...
        this.createSealRecord = (opts) => __awaiter(this, void 0, void 0, function* () {
            if (!opts.key && opts.write) {
                opts = Object.assign({}, opts, { key: yield this.provider.getMyChainKey() });
            }
        ...
        this._updateWithSeal = ({ seal, object }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (lost.length) {
                ...
                this.logger.error(`before in s3: ${string_utils_1.prettify(object)}, before in db: ${string_utils_1.prettify(before)}, after: ${string_utils_1.prettify(saved)}`);
            }
        });
        this._updateDBWithSeal = ({ sealResource, object }) => __awaiter(this, void 0, void 0, function* () {
            const props = _.pick(object, [constants_1.TYPE, '_time', '_link', '_permalink', '_virtual']);
            try {
                yield this.db.update(Object.assign({}, props, { _seal: sealResource }));
            }
            catch (err) {
                Errors.ignore(err, { name: 'ConditionalCheckFailedException' });
                this.logger.warn(`failed to update resource ${buildResource.id(object)} in db with seal.
        This is most likely because a newer version of the resource exists and the db
        only keeps the latest version.`);
            }
        });
        this.getNewSealParams = ({ key, object, link, permalink, counterparty, watchType = WATCH_TYPE.this, write }) => {
            if (!(link && permalink) && object) {
                ({ link, permalink } = crypto_1.getLinks(object));
            }
