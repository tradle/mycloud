...
const exp = {
    ...
    get Lambda() {
        return require_default_1.requireDefault('./lambda');
    },
    get Identities() {
    ...
    get ContentAddressedStore() {
        return require_default_1.requireDefault('./content-addressed-store');
    },
    get KeyValueTable() {
    ...
    get createBot() {
        return require_default_1.requireDefault('./bot').createBot;
    }
};
module.exports = exp;
