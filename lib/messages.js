...
const { MESSAGE, } = constants_2.TYPES;
class Messages {
    constructor(tradle) {
        ...
        this.getPropsDerivedFromLast = (last) => {
            ...
            const props = { [constants_2.SEQ]: seq };
            if (last) {
                props[constants_2.PREV_TO_RECIPIENT] = last.link;
            }
            return props;
        };
        this.formatForDB = (message) => {
        ...
        this.getLastSeqAndLink = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            query.ExpressionAttributeNames[`#${constants_2.SEQ}`] = constants_2.SEQ;
            query.ProjectionExpression = `#${constants_2.SEQ}, #link`;
            let last;
            try {
                last = yield this.outbox.findOne(query);
                this.logger.debug('last message', last);
                return {
                    seq: last[constants_2.SEQ],
                    link: last._link
                };
            }
            catch (err) {
        ...
        this.processInbound = (message) => __awaiter(this, void 0, void 0, function* () {
            const min = message;
            ...
            if (payload[constants_2.PREVLINK]) {
                this.objects.prefetch(payload[constants_2.PREVLINK]);
            }
        ...
        this.getMessagePayload = ({ bot, message }) => __awaiter(this, void 0, void 0, function* () {
            if (message.object[constants_1.SIG]) {
                return message.object;
            }
            return yield this.objects.get(crypto_1.getLink(message.object));
        });
        this.savePayloadToDB = (message) => __awaiter(this, void 0, void 0, function* () {
            const type = message.object[constants_1.TYPE];
            const ignored = message._inbound
                ? constants_2.DB_IGNORE_PAYLOAD_TYPES.inbound
                : constants_2.DB_IGNORE_PAYLOAD_TYPES.outbound;
            ...
            yield this.objects.replaceEmbeds(copy);
            yield this.db.put(copy);
            return true;
        });
