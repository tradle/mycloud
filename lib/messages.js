...
class Messages {
    constructor(opts) {
        ...
        this.getMessageStub = ({ message, error }) => {
            const stub = {
        ...
        this.putOutboundMessage = ({ message, item }) => __awaiter(this, void 0, void 0, function* () {
            yield this.outbox.put({ Item: item });
        });
        this.putInboundMessage = ({ message, item }) => __awaiter(this, void 0, void 0, function* () {
            const params = {
                Item: item,
        ...
        this.loadMessage = (message) => __awaiter(this, void 0, void 0, function* () {
            const body = yield this.objects.getObjectByLink(crypto_1.getLink(message.object));
        ...
        this.getMessagesFrom = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.maybeAddBody({
                messages: yield this.find(this.inbox, params),
                body
            });
        });
        ...
        this.maybeAddBody = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            return yield Promise.all(messages.map(this.loadMessage));
        });
        ...
        this.getMessagesTo = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.maybeAddBody({
                messages: yield this.find(this.outbox, params),
                body
            });
        });
        this.getLastMessageTo = ({ recipient, body = true }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getInboundByLink = function getInboundByLink(link) {
        ...
        this.parseInbound = (message) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.object._sigPubKey === message._sigPubKey) {
                addPayloadAuthor = addMessageAuthor.then(() => {
                    utils_1.setVirtual(message.object, { _author: message._author });
                });
            }
            else {
        ...
        this.findOne = (table, params) => {
            return table
                .findOne(params)
                .then(this.messageFromEventPayload);
        };
        this.find = (table, params) => {
            return table
                .find(params)
