...
class Messages {
    constructor(opts) {
        this.normalizeInbound = (message) => {
            ...
            if (!recipientPubKey) {
                throw new errors_1.default.InvalidMessageFormat('unexpected format');
            }
        ...
        this.putInboundMessage = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (err.code === 'ConditionalCheckFailedException') {
                    throw new errors_1.default.Duplicate('duplicate inbound message', crypto_1.getLink(message));
                }
                throw err;
            }
        });
        ...
        this.getLastSeqAndLink = (opts) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (err instanceof errors_1.default.NotFound) {
                    return null;
                }
        ...
        this.assertTimestampIncreased = (message) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (prev._link === link) {
                    throw new errors_1.default.Duplicate('duplicate inbound message', link);
                }
                if (prev.time >= time) {
                    const msg = `TimeTravel: timestamp for message ${link} is <= the previous messages's (${prev._link})`;
                    this.logger.debug(msg);
                    throw new errors_1.default.TimeTravel(msg, link);
                }
            }
            catch (err) {
                if (!(err instanceof errors_1.default.NotFound)) {
        ...
        this.preProcessInbound = (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (message[constants_1.TYPE] !== MESSAGE) {
                throw new errors_1.default.InvalidMessageFormat('expected message, got: ' + message[constants_1.TYPE]);
            }
...
const validateInbound = (message) => {
    try {
        ...
        throw new errors_1.default.InvalidMessageFormat(err.message);
    }
};
