...
class UserSim {
    constructor(tradle) {
        ...
        this.requestIotClientReconnect = ({ clientId, error, message = 'please reconnect' }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.onPreAuth = (opts) => __awaiter(this, void 0, void 0, function* () {
            return yield this.auth.createTemporaryIdentity(opts);
        });
        this.onSentChallengeResponse = (response) => __awaiter(this, void 0, void 0, function* () {
            const time = Date.now();
