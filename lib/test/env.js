...
const props = Object.assign({}, process.env, serviceMap, { NODE_ENV: 'test', AWS_REGION: 'us-east-1', IS_LOCAL: true });
exports.createTestEnv = () => {
    const Env = require('../env').default;
    return new Env(props);
};
exports.install = (target = process.env) => {
    if (target instanceof env_1.default) {
        target.set(props);
    }
    else {
...
exports.get = () => (Object.assign({}, props));
