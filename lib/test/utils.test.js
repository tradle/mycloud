...
test('getCacheable', utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const { aws } = tradle;
    const { s3 } = aws;
    const bucketName = `test-${crypto_1.randomString(10)}`;
...
test('Bucket', utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    ...
    const bucket = new bucket_1.Bucket({ name: bucketName, s3, env });
    yield bucket.create();
    const ops = [
...
test('ModelStore', utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    ...
    let memBucket = {};
    const fakePut = ({ key, value }) => __awaiter(this, void 0, void 0, function* () {
        memBucket[key] = value;
    });
    const fakeGet = ({ key }) => __awaiter(this, void 0, void 0, function* () {
        if (!(key in memBucket)) {
            throw new Errors.NotFound(key);
        }
        return memBucket[key];
    });
    sinon.stub(tradle.s3Utils, 'get').callsFake(({ key }) => __awaiter(this, void 0, void 0, function* () {
        const Body = yield fakeGet({ key });
        return {
    ...
    yield store.saveCustomModels({
        modelsPack: {
            namespace: 'ping.pong',
            models: _.values(ping_pong_models_1.models)
        }
    });
    let cumulative = yield store.getCumulativeModelsPack();
    let isCumulative = modelsPack.models.concat(_.values(ping_pong_models_1.models)).every(model => {
    ...
    isCumulative = modelsPack.models
        ...
        .concat(_.values(ping_pong_models_1.models))
        .every(model => {
        return cumulative.models.find(m => m.id === model.id);
    });
