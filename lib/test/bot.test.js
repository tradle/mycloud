...
test(`users `, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    yield utils_2.recreateTable(UsersTableLogicalId);
    const bot = bot_1.createBot({ tradle: _1.createTestTradle() });
    const { users } = bot;
    const user = {
        id: bob.permalink,
        identity: bob.object
...
test(`onmessage`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    t.plan(5);
    const tradle = _1.createTestTradle();
...
test(`readseal`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
...
test(`use()`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const expectedArg = {};
    const called = {
        usercreate: false,
        useronline: false,
