...
[bot_1.createBot].forEach((createBot, i) => {
    const mode = createBot === createFakeBot ? 'mock' : 'real';
    test(`users (${mode})`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
        if (mode === 'real') {
            yield utils_2.recreateTable(UsersTableLogicalId);
        }
        const bot = createBot({ tradle: _1.createTestTradle() });
        const { users } = bot;
        const user = {
            id: bob.permalink,
            identity: bob.object
    ...
    test('init', utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
        ...
        sinon.stub(tradle.init, 'init').callsFake((opts) => __awaiter(this, void 0, void 0, function* () {
            t.same(opts, expectedEvent.payload);
        }));
        let { callCount } = cfnResponse.send;
        bot.oninit((event) => __awaiter(this, void 0, void 0, function* () {
    ...
    test(`onmessage (${mode})`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
        t.plan(6);
        const tradle = _1.createTestTradle();
        ...
        const { users } = bot;
        let updatedUser;
        users.merge = () => __awaiter(this, void 0, void 0, function* () {
            updatedUser = true;
        });
        users.createIfNotExists = (user) => __awaiter(this, void 0, void 0, function* () {
        ...
        const message = {
            [constants_1.TYPE]: 'tradle.Message',
            [constants_1.SEQ]: 0,
            [constants_1.SIG]: crypto.randomBytes(128).toString('base64'),
            time: 123,
            _payloadType: payload[constants_1.TYPE],
        ...
        sinon.stub(tradle.user, 'onSentMessage').callsFake(() => __awaiter(this, void 0, void 0, function* () {
            return message;
        }));
        bot.hook('message', (data) => __awaiter(this, void 0, void 0, function* () {
            const { user } = data;
            user.bill = 'ted';
            t.equal(user.id, message._author);
    ...
    test(`readseal (${mode})`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
        ...
        const bot = createBot({ tradle });
        bot.hook('readseal', (event) => __awaiter(this, void 0, void 0, function* () {
            read = true;
            t.equal(event.link, link);
        }));
        bot.hook('wroteseal', (event) => __awaiter(this, void 0, void 0, function* () {
            wrote = true;
            t.equal(event.link, link);
        }));
        yield bot.lambdas.onsealstream().handler(utils_2.toStreamItems([
            {
                old: {
                    link,
                    unsealed: 'x'
    ...
    test(`use() (${mode})`, utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
        const expectedArg = {};
        const called = {
            usercreate: false,
            useronline: false,
        ...
        bot.use(() => {
            Object.keys(called).forEach(event => {
                bot.hook(event, (arg) => __awaiter(this, void 0, void 0, function* () {
...
test('onmessagestream', utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const message = {
    ...
    const table = yield bot.db.getTableForModel('tradle.Ping');
    t.ok(table, 'table created per model');
    const { users } = bot;
    const stubGet = sinon.stub(bot.objects, 'get').callsFake((link) => __awaiter(this, void 0, void 0, function* () {
    ...
    bot.hook('message', (data) => __awaiter(this, void 0, void 0, function* () {
        ...
        user.bill = 'ted';
        t.equal(user.id, message._author);
        t.same(data.message, Object.assign({}, message, { object: Object.assign({}, message.object, payload) }));
    }));
    let updatedUser;
    users.merge = () => __awaiter(this, void 0, void 0, function* () {
        updatedUser = true;
    });
    yield bot.lambdas.onmessagestream().handler(utils_2.toStreamItems([
        { new: message }
    ]), {
        done: t.error
    });
    const gql = graphql_1.getGraphqlAPI({ bot });
...
test('validate send', utils_1.loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const tradle = _1.createTestTradle();
    ...
    const bot = bot_1.createBot({ tradle, models });
    try {
        yield bot.send({
            to: bob.permalink,
            object: {}
