...
const gen_samples_1 = require("@tradle/gen-samples");
const embed_1 = require("@tradle/embed");
...
const genIdentity = (tradle) => __awaiter(this, void 0, void 0, function* () {
    ...
    return {
        identity: _1.utils.omitVirtual(identity),
        keys,
...
class Test {
    constructor({ tradle = defaultTradleInstance, bot, productsAPI, employeeManager }) {
        this._init = () => __awaiter(this, void 0, void 0, function* () {
            ...
            this.bot.ready();
            this.debug('bot permalink', _1.crypto.getPermalink(this.bot.identity));
        });
        this.runEmployeeAndCustomer = wrapWithIntercept(({ product }) => __awaiter(this, void 0, void 0, function* () {
            yield this._ready;
            ...
            employee.on('message', (message) => __awaiter(this, void 0, void 0, function* () {
                if (message.object[constants_1.TYPE] === MESSAGE) {
                ...
                yield bot.objects.resolveEmbeds(message);
        ...
        this.runEmployeeAndFriend = wrapWithIntercept(() => __awaiter(this, void 0, void 0, function* () {
            ...
            nock(url)
                ...
                assert.equal(msg.object[constants_1.TYPE], SIMPLE_MESSAGE);
        ...
        this.runThroughApplication = ({ user, awaitCertificate, product, relationshipManager }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield user.waitFor(message => {
                ...
                return object[constants_1.TYPE] === 'tradle.FormRequest' &&
            ...
            while (!stop) {
                ...
                for (let message of messages) {
                    ...
                    let type = object[constants_1.TYPE];
                    if (type === 'tradle.FormRequest') {
                        let form = gen_samples_1.fake({
                            models,
    ...
    constructor({ tradle, identity, keys, profile, name, bot }) {
        ...
        this.awaitType = (type) => __awaiter(this, void 0, void 0, function* () {
            return this.waitFor(message => {
                return message.object[constants_1.TYPE] === type;
            });
        });
        ...
        this.send = ({ object, other }) => __awaiter(this, void 0, void 0, function* () {
            yield this._ready;
            this.debug('sending', object[constants_1.TYPE]);
        ...
        this._createMessage = ({ object, other = {} }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const unsigned = _.extend({
                [constants_1.TYPE]: 'tradle.Message',
                [constants_1.SEQ]: this._userSeq++,
                time: Date.now(),
                recipientPubKey: this.botPubKey,
                object: _1.utils.omitVirtual(object)
            }, other);
            const message = yield this.sign(unsigned);
            message.object = object;
            const replacements = embed_1.replaceDataUrls({
        ...
        this.permalink = _1.crypto.getPermalink(this.identity);
        this.clientId = this.permalink.repeat(2);
        this.keys = keys;
        this.profile = profile;
        this.bot = bot;
        this.userPubKey = engine_1.utils.sigPubKey(this.identity);
        this.botPubKey = engine_1.utils.sigPubKey(bot.identity);
        this._userSeq = 0;
        this._botSeq = 0;
        this.on('message', message => {
            ...
            while (payload.object) {
                types.push(payload.object[constants_1.TYPE]);
                payload = payload.object;
            }
            this.debug('received', types.join(' -> '));
            if (payload[constants_1.TYPE] === 'tradle.FormRequest') {
...
function recordTypes(user, types) {
    return function (message) {
        const type = message.object[constants_1.TYPE];
