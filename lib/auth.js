...
class Auth {
    constructor(opts) {
        ...
        this.setConnected = ({ clientId, connected }) => __awaiter(this, void 0, void 0, function* () {
            if (!connected) {
                return this.tables.Presence.update(Object.assign({ Key: getKeyFromClientId(clientId) }, db_utils_1.getUpdateParams({ connected: false, subscribed: false })));
            }
        ...
        this.setSubscribed = ({ clientId, subscribed }) => __awaiter(this, void 0, void 0, function* () {
            if (!subscribed) {
                return this.tables.Presence.update(Object.assign({ Key: getKeyFromClientId(clientId) }, db_utils_1.getUpdateParams({ subscribed: false })));
            }
            return this.tables.Presence.update({
                Key: getKeyFromClientId(clientId),
        ...
        this.createTemporaryIdentity = (opts) => __awaiter(this, void 0, void 0, function* () {
            try {
                utils_1.typeforce({
