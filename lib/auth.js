...
class Auth {
    constructor(opts) {
        ...
        this.setConnected = ({ clientId, connected }) => __awaiter(this, void 0, void 0, function* () {
            if (!connected) {
                return yield this.updateSession({ clientId }, {
                    connected: false,
                    subscribed: false
                });
            }
        ...
        this.updateSession = ({ clientId }, update) => __awaiter(this, void 0, void 0, function* () {
            return yield this.tables.Presence.update(Object.assign({}, db_utils_1.getUpdateParams(update), { Key: getKeyFromClientId(clientId), ReturnValues: 'ALL_NEW' }));
        });
        this.env = opts.env;
        this.aws = opts.aws;
