...
class Init {
    constructor({ bot }) {
        ...
        this.savePublicConf = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.confManager.savePublicConf(pub);
        });
        this.savePrivateConf = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.confManager.savePrivateConf(this.priv, opts.forceReinitializeContainers);
        });
        ...
        this.update = (conf) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.confManager.forceReinitializeContainers();
        });
