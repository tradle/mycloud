...
class Conf {
    constructor({ bot, logger }) {
        ...
        this.setStyle = (style, reinitializeContainers = true) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.style.put(style);
        });
        this.getIntroTour = () => __awaiter(this, void 0, void 0, function* () {
            const conf = yield this.botConf.get();
            return dotProp.get(conf, 'tours.intro');
        });
        this.getPublicInfo = () => __awaiter(this, void 0, void 0, function* () {
            const [org, style, identity, tour] = yield Promise.all([
                this.org.get(),
                this.style.get(),
        ...
        this.calcPublicInfo = ({ identity, org, style, tour }) => {
            return {
                bot: {
                    profile: {
                        name: {
