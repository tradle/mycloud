...
exports.name = 'termsAndConditions';
exports.createPlugin = ({ logger, productsAPI, employeeManager, termsAndConditions }) => {
    const onmessage = (req) => __awaiter(this, void 0, void 0, function* () {
        const { user, payload, type } = req;
        if (user.friend || employeeManager.isEmployee(user))
            return;
        if (type === TERMS_AND_CONDITIONS &&
            ...
            yield productsAPI.sendProductList({ to: user });
            return;
        }
...
exports.ensureAccepted = ({ termsAndConditions, user, productsAPI, logger }) => __awaiter(this, void 0, void 0, function* () {
