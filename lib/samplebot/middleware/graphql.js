...
exports.createMiddleware = (lambda, components) => {
    ...
    utils_1.defineGetter(middleware, 'setGraphiqlOptions', () => router.setGraphiqlOptions);
    utils_1.defineGetter(middleware, 'getGraphiqlAPI', () => router.getGraphiqlAPI);
    return middleware;
};
