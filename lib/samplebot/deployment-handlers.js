...
const MIN_SCALE = 1;
const MAX_SCALE = 1;
function createDeploymentHandlers({ bot, deploymentModels }) {
    const { SERVERLESS_STAGE, SERVERLESS_SERVICE_NAME, ORG_DOMAIN } = bot.env;
    ...
    const getBaseTemplate = (function () {
        ...
        return ({ s3, resources }) => __awaiter(this, void 0, void 0, function* () {
    ...
    const writeTemplate = ({ s3, resources, parameters }) => __awaiter(this, void 0, void 0, function* () {
...
exports.default = createDeploymentHandlers;
