...
const prefill_form_1 = require("./prefill-form");
        ...
        productsAPI.plugins.use({
            ...
            onFormsCollected: ({ req, user, application }) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!approved) {
                    ...
                    const issued = yield productsAPI.issueVerifications({
            ...
            didApproveApplication: ({ req, user, application, approvedBy }) => __awaiter(this, void 0, void 0, function* () {
                if (approvedBy) {
                    const issued = yield productsAPI.issueVerifications({ req, user, application, send: true });
