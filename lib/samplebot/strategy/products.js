...
function createProductsBot(opts = {}) {
    const { tradle = _1.tradle, models = baseModels, products = DEFAULT_PRODUCTS, namespace = 'test.bot', approveAllEmployees, autoVerify, autoApprove, graphqlRequiresAuth } = opts;
