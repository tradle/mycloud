...
const doSign = promisify(engine_1.protocol.sign.bind(engine_1.protocol));
...
const unserializeEncrypted = (buf) => {
    const parts = [];
    const l = buf.length;
    let idx = 0;
    while (idx < l) {
...
const sign = utils_1.loudAsync(({ key, object }) => __awaiter(this, void 0, void 0, function* () {
    utils_1.ensureNoVirtualProps(object);
...
const _genIdentity = promisify(engine_1.utils.newIdentity);
const genIdentity = (opts) => __awaiter(this, void 0, void 0, function* () {
    const { link, identity, keys } = yield _genIdentity(opts);
    utils_1.setVirtual(identity, {
        _link: link,
        _permalink: link
    });
    return {
