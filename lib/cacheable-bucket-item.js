...
class CacheableBucketItem {
    constructor(opts) {
        ...
        this.get = (opts) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.value.get(opts);
        ...
        this.putIfDifferent = (value, opts = {}) => __awaiter(this, void 0, void 0, function* () {
            const updated = yield this.bucket.putIfDifferent(this.key, value);
            if (updated)
