...
const { TABLES_TO_PRECREATE } = require('./constants')
...
proto.preCreateTables = co(function* () {
  const { db, models } = this
  yield TABLES_TO_PRECREATE.map(co(function* (id) {
    try {
