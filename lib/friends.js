    ...
    constructor(tradle) {
        ...
        this.add = (props) => __awaiter(this, void 0, void 0, function* () {
            ...
            const object = buildResource({ models, model })
                .set(Object.assign({}, utils_1.pick(existing, keys), utils_1.pick(props, keys), { _identityPermalink: identity._permalink }))
                .toJSON();
            const isSame = Object.keys(object).every(prop => {
                return lodash_1.isEqual(object[prop], existing[prop]);
            });
            if (isSame) {
        ...
        this.getByDomain = (domain) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.removeByIdentityPermalink = (permalink) => __awaiter(this, void 0, void 0, function* () {
            yield this.db.del({
                [constants_1.TYPE]: FRIEND_TYPE,
                _identityPermalink: permalink
            });
        });
        this.removeByDomain = (domain) => __awaiter(this, void 0, void 0, function* () {
            const friend = yield this.getByDomain(domain);
            yield this.removeByIdentityPermalink(friend._identityPermalink);
        });
        ...
        this.getByIdentityPermalink = utils_1.cachifyFunction(this, 'getByIdentityPermalink');
    }
}
