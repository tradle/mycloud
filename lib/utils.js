...
exports.launchStackUrl = function launchStackUrl({ region = process.env.AWS_REGION, stackName, templateURL }) {
...
exports.summarizeObject = object => {
    ...
    const summary = Object.assign({}, links, { type: object[TYPE] });
