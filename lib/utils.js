...
function cachify({ get, put, del, logger, cache }) {
    ...
    return {
        ...
        del: co_1.wrap(function* (key) {
            cache.del(string_utils_1.stableStringify(key));
...
exports.onWarmUp = ({ env, event, context, callback }) => {
    env.debug(`warmup, sleeping for ${constants_1.WARMUP_SLEEP}ms`);
    setTimeout(() => {
...
exports.flatten = arr => arr.reduce((flat, batch) => flat.concat(batch), []);
...
exports.cachifyFunction = (container, method) => {
    ...
    return (...args) => __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield original.apply(container, args);
