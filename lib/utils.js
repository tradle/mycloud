...
const { parseId, parseStub, omitVirtual, setVirtual, pickVirtual, stripVirtual, omitVirtualDeep, hasVirtualDeep } = validateResource.utils;
...
exports.stripVirtual = stripVirtual;
exports.omitVirtualDeep = omitVirtualDeep;
exports.hasVirtualDeep = hasVirtualDeep;
...
exports.updateTimestamp = (resource, time = Date.now()) => {
...
exports.ensureTimestamped = (resource) => {
    if (!resource._time) {
        if (resource.time) {
            ...
            exports.updateTimestamp(resource);
        }
    }
    return resource;
};
...
exports.copyVirtual = (target, source) => {
    stripVirtual(target);
