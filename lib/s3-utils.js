...
module.exports = function createUtils(aws) {
    ...
    const put = ({ key, value, bucket, contentType }) => __awaiter(this, void 0, void 0, function* () {
        logger.debug('putting', { key, bucket, type: value[constants_1.TYPE] });
        const opts = {
            Bucket: bucket,
            Key: key,
    ...
    const get = (_a) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield aws.s3.getObject(params).promise();
            logger.debug('got', { key, bucket, type: result[constants_1.TYPE] });
            return result;
        }
        catch (err) {
    ...
    const getCacheable = (_a) => {
        ...
        const maybeGet = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            opts = Object.assign({}, defaultOpts, omit(opts, ['force']));
            if (etag) {
