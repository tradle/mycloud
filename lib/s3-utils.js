...
function createUtils({ s3, logger }) {
    ...
    const gzipAndPut = (opts) => __awaiter(this, void 0, void 0, function* () {
        ...
        return yield put(Object.assign({}, opts, { value: yield utils_1.gzip(toStringOrBuf(value)), headers: Object.assign({}, { ContentEncoding: 'gzip' }) }));
    });
    ...
    const getCacheable = (_a) => {
        ...
        const maybeGet = (opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            opts = Object.assign({}, defaultOpts, lodash_1.omit(opts, ['force']));
            if (etag) {
