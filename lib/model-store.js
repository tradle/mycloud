...
class ModelStore extends events_1.EventEmitter {
    constructor(tradle) {
        ...
        this.updateCumulativeModelsPackWithPack = (pack) => __awaiter(this, void 0, void 0, function* () {
            yield this.validateInboundModelsPack(pack);
            ...
            yield this.bucket.putJSON(CUMULATIVE_PACK_KEY, cumulative);
            return cumulative;
        });
        this.getCumulativeModelsPack = () => __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.bucket.getJSON(CUMULATIVE_PACK_KEY);
            }
            catch (err) {
