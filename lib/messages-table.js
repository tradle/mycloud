...
function createMessagesTable({ docClient, models, getMyIdentity }) {
    ...
    const execQuery = (method, query) => __awaiter(this, void 0, void 0, function* () {
        ...
        const inboundFilter = Object.assign({}, filter, { IN, EQ: _.clone(EQ) });
        const outboundFilter = Object.assign({}, filter, { IN, EQ: _.clone(EQ) });
        if (counterparty) {
