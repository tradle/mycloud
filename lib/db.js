...
module.exports = function createDB(opts) {
    ...
    db.setExclusive({
        ...
        table: dynamodb_1.createTable(pubKeysDef.TableName, Object.assign({}, commonOpts, { model: models['tradle.PubKey'], tableDefinition: dynamodb_1.utils.toDynogelTableDefinition(pubKeysDef) }))
    });
    return db;
};
