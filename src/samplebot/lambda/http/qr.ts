...
import { getChatLink, getApplyForProductLink, inferSchemaAndData } from '../../app-links'
...
const descriptions = {
  ...
  AddProvider: (data: IDeepLink) => `scan this QR code with the Tradle app or open <a href="${getChatLink(data)}">this link</a> on your mobile device to add this provider to your Conversations screen`,
  ApplyForProduct: (data: IApplyForProductDeepLink) => `scan this QR code with the Tradle app or open <a href="${getApplyForProductLink(data)}">this link</a> on your mobile device to add this provider to your Conversations screen, and apply for ${data.product}`,
}
