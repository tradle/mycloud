...
const ageModels = require('@tradle/bot-products/test/fixtures/agemodels')
const ageVerificationStrategy = require('@tradle/bot-products')({
...
const bot = createBot()
ageVerificationStrategy.install(bot)
